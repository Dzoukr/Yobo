...
<li>Cena permanentky 1100 Kč = 10 kreditů = 10 lekcí (cena jedné lekce 110 Kč), platnost 4 měsíce nebo 2100 Kč = 20 kreditů = 20 lekcí (cena jedné lekce 105 Kč), platnost 8 měsíců. Platnost všech permanentek je však maximálně do poslední lekce konané v aktuálním školním roce. K poslednímu červnu budou nevybrané kredity ze všech účtů smazány. Prosím, pohlídejte si, abyste všechny kredity stačili vychodit.</li>
