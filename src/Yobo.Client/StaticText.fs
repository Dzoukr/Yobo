...
<li>Pokud chodíte nepravidelně nebo dáváte přednost platbě v hotovosti po každé lekci, klikněte na tlačítko Rezervovat. Cena druhé a dalších lekcí při platbě vždy po skončení lekce je 140 Kč. Při jednorázových platbách v hotovosti vždy lze dopředu zarezervovat pouze jednu lekci.</li>
<li>Cena permanentky 1100 Kč = 10 kreditů = 10 lekcí (cena jedné lekce 110 Kč), platnost 4 měsíce, permanentka je nepřenosná. S permanentkou lze navštěvovat jakékoliv lekce v Gapíku. Permanentku možno zakoupit buď platbou na účet 1681695016/3030 (do poznámky uveďte celé své jméno) nebo uhradit v hotovosti na lekci.</li>
...
<li>Přihlašování na lekce a odhlašování lze provádět kdykoliv s výjimkou dne konání lekce, kdy se od 9:00 lze pouze přihlašovat (viz. Storno podmínky).</li>
</ol>
</p>
...
<p>
<ol>
<li>Odhlášení z lekce je možno provést nejpozději v den konání lekce do 9:00 kliknutím na tlačítko Zrušit rezervaci.</li>
<li>V případě rezervace za kredit Vám bude kredit připsán zpět na účet. Pokud se nestihnete odhlásit do 9:00, kredit propadá.</li>
<li>V případě rezervace za hotovost bude přihlášení zrušeno a vy máte možnost přihlásit se na jinou lekci. Pokud se nestihnete odhlásit do 9:00, buď pošlete platbu za lekci na účet nebo platbu za lekci uhradíte při následující lekci. Pokud se podruhé přihlásíte na lekci, včas se neodhlásíte a nedorazíte, systém Vám neumožní další rezervaci lekce.</li>
<li>Přihlásit se na lekci, můžete kdykoliv před začátkem konání lekce, pokud je na ní volno. Pokud je tedy lekce obsazená, prosím sledujte rezervační systém, je možné, že se někdo odhlásil do 9:00.</li>
<li>Pokud jste si zakoupili permanentku a chcete chodit pouze na jednu lekci, může se stát, že lekce bude obsazena a vy si ji nebudete moci zarezervovat. Prosím sledujte rezervační systém a pokud se místo neuvolní v den lekce po 9:00, můžete mně kontaktovat a požádat o prodloužení platnosti permanentky. Platnost permanentky Vám bude o týden posunuta.</li>
