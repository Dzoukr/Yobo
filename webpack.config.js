...
var CONFIG = {
    ...
    indexHtmlTemplate: './src/Yobo.Client/public/index.html',
    fsharpEntry: './src/Yobo.Client/Yobo.Client.fsproj',
    cssEntry: './src/Yobo.Client/styles/app.scss',
    outputDir: './src/Yobo.Client/output',
    assetsDir: './src/Yobo.Client/public',
    devServerPort: 8080,
